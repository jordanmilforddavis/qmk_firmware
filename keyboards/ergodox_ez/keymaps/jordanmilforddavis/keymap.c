...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_F4,          KC_MAC_COPY,    KC_MAC_PASTE,   LCTL(KC_LEFT),  LT(1,KC_SPACE),                                                                                                 KC_ENTER,       LCTL(KC_TAB),   KC_TRANSPARENT, KC_TRANSPARENT, LT(3, KC_SLASH),
                                                                                                    RGB_SAD,        RGB_SAI,        RGB_MOD,        RGB_SLD,
                                                                                                                    RGB_VAI,        RGB_HUI,
                                                                                    LT(2,KC_TAB),   LT(2,KC_TAB),   RGB_VAD,        RGB_HUD,        KC_BSPACE,      KC_BSPACE
  ),
